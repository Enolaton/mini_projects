...
### 🔍 분석배경(Analysis Background)
  ...
  - HMM 주가 그래프와 SCFI, WTI를 비교함
    - SCFI : 상하이 컨테이너 지수 (Shanghai Containerized Freight Index)
    - WTI : 서부 텍사스산 원유 지수 (West Texas Intermediate)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
